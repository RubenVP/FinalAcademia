...
VALUES ('user','user123', true, 'Ruben', 'Valderrabano', 'ruben.valderrabano@softtek.com', 'C:\Users\ruben.valderrabano\Desktop\spring-tool-suite-3.7.0.RELEASE-e4.5-win32-x86_64\sts-bundle\pivotal-tc-server-developer-3.1.1.RELEASE\base-instance\wtpwebapps\appacademy\admin.PNG');
